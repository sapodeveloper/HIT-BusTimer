...
<head>
    ...
    <link rel="apple-touch-icon-precomposed apple-touch-icon" href="../img/bt.png" />
    ...
    <script type="text/javascript" src="./ac_config.js"></script>
    <script type="text/javascript" src="./ac_disp.js"></script>
    <script type="text/javascript">
    // 初期設定
    function startup(){
	   time_table();
...
<body onload="startup()">
    ...
    <div style="font-size:13pt" data-role="header">
        ...
        <a rel="external" href="../st/" data-role="button">五日市発に切替</a></center>
    </div>
    <div align="center">
    <div data-role="content" data-theme="e" data-content-theme="e">
		...
		<tr>
		  <td align="center" bgcolor="#FBF5EF">
		      <?php
		         if($s=='1')echo "<img src=\"../img/hit_tuujou.jpg\" />";
			     if($s=='2')echo "<img src=\"../img/hit_rinji.jpg\" />";
			     if($s=='4')echo "<img src=\"../img/hit_kyuusi.jpg\" />";
	          ?>
		  </td>
		</tr>
		<tr>
		  <td align=center>
		      <form name="time_table">
		          <input type="text" name="table1" id = "table1" size="30" readonly style="width: 238px; height: 50px; font-size: 50px; text-align: center;>
	      </td>
		</tr>
	</table>
	...
	<table border=0 cellspacing=0 cellpadding=0 width="1px">
	    ...
	    <td align=center width="0px">時刻表<br>
	       <textarea name="table2" rows=3 cols=10 style="overflow:hidden; width: 100px; height: 140px; font-size: 25px; text-align: right;" readonly></textarea>
	       </form>
	    </td>
    ...
    <a rel="external" data-icon="star" data-inline=“true” href="https://sites.google.com/site/hitsolu/" data-role="button">HP</a></p>
    </center>
    </div>
    </div>
</font>
